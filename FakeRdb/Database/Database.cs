...
{
    public void Insert(string tableName, string[] columns, IR.ValuesTable values)
    {
    ...
    public int Delete(string tableName, IR.IExpression? projection)
    {
        var table = this[tableName];
        if (projection != null)
